...
public class AuthStateEntity implements java.io.Serializable {
    ...
    public AuthStateEntity(BigDecimal authState, Long expiration,
	...
	public String toString() {
		return String
				.format("AuthState [userId=%s, authState=%s, token=%s, expiration=%s, lastLogin=%s, ipAddress=%s]",
						userId, authState, token, expiration, lastLogin,
						ipAddress);
	}
