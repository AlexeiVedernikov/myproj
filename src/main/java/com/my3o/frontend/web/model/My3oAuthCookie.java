...
public class My3oAuthCookie {
	...
	public My3oAuthCookie(final String userId, final String principal, final String token, final String userRole,
	 ...
	 */
	public static My3oAuthCookie getToken(final String value) {
		...
		if(StringUtils.isNotBlank(value)) {
			...
			if(split != null && split.length >= 3) {
				...
				retVal = new My3oAuthCookie(userId, principal, token, userRole, expriationTime);
			}
		}
		return retVal;
	}
	...
	public String toString() {
		return String
				.format("My3oAuthCookie [principal=%s, userId=%s, token=%s, userRole=%s, expriationTime=%s]",
