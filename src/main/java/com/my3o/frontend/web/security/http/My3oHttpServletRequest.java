package com.my3o.frontend.web.security.http;

import com.my3o.frontend.web.util.XSSUtils;
...
public class My3oHttpServletRequest extends HttpServletRequestWrapper {
	
	private static Logger LOG = Logger.getLogger(My3oHttpServletRequest.class);

	private boolean preventXSS;
	private Map<String, String[]> xssSafeParams;
	
	public My3oHttpServletRequest(final HttpServletRequest request) {
		super(request);
	}

	public My3oHttpServletRequest(final HttpServletRequest request, final boolean preventXSS) {
		super(request);
