...
import com.my3o.common.constant.My3oConstants;
...
//	private KeyManagementWS keyManagementServiceClient;
	...
	private void init() {
		if(!initialized) {
			try {
				key =  "My3oCookieSecurityEncryptKey#256".getBytes(); //keyManagementServiceClient.getCookieKey();
	...
	public String encode(final String plainTextCookieValue) throws Exception {      
		...
		byte[] input = plainTextCookieValue.getBytes(My3oConstants.UTF_8);
