package com.my3o.rest.transport;
...
public abstract class HttpRequestWrapper {
    ...
    public static HttpRequestWrapper getInstance(ContentType contentType, String method, UrlWrapper url,
    ...
    public String execute(HashMap<String, String> headers) throws Exception {
        ...
        httpClient.addRequestInterceptor(new HttpRequestInterceptor() {
            ...
            public void process(final HttpRequest request, final HttpContext context) throws HttpException, IOException {
                // flag
                // QiwiClient useGzip = new QiwiClient();
                // if (useGzip.getUseAcceptEncodingGzip() == true) {
        ...
        try {
            ...
            return new String(httpClient.execute(this.request, responseHandler).getBytes("UTF-8"));
    ...
    public void setBody(Object body) throws Exception {
        ...
        if (requestMethod.equals("PUT") || requestMethod.equals("POST")) {
            ...
            if (body instanceof String) {
                ...
                InputStreamKnownSizeBody bin = new InputStreamKnownSizeBody(new FileInputStream((File) body),
                        (int) (((File) body).length()), "image/jpeg", ((File) body).getName());
    ...
    static class InputStreamKnownSizeBody extends InputStreamBody {
        ...
        public InputStreamKnownSizeBody(final InputStream in, final int lenght, final String mimeType,
