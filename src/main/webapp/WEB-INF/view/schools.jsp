...
<html>
    <head>
        ...
        <title><fmt:message key="my3o.ui.menu.guides.schools" /> - <fmt:message key="my3o.ui.title" /></title>
    ...
    <body>
        ...
        <div class="container min_H_400">
            ...
            <h4 class="pull-left"><fmt:message key="my3o.ui.menu.guides.schools" /></h4>
